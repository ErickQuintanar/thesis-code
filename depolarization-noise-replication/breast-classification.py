...
# Strongly entangled binary classificator for breast cancer dataset
...
# Retrieve dataset and split the dataset into training and testing sets (80/20 split)
df = pd.read_csv('../replication-datasets/breast_cancer_preprocessed.txt', sep='\t')
...
filename = "reports/breast_results.csv"
