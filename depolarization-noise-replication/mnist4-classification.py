...
def circuit(parameters, x):
    ...
    # TODO: Choose which method to calculate the probs
...
# Strongly entangled binary classificator for MNIST4 dataset
...
def cost(weights, bias, X, Y):
    # TODO: Modify loss to log_loss from sklearn probs
...
def threshold(prediction):
    # Choose highest probability from probability distribution
    return np.max(prediction, axis=0)
